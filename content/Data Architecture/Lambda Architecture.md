...
- 加速层：该层的核心功能是处理增量实时数据，生成实时视图，快速执行即席查询。架构实现方面可以使用 [[HDFS]] 或 [[Apache HBase|Hbase]] 存储实时数据，利用 [[Apache Spark|Spark]] 或 [[Apache Storm]] 实现实时数据处理和实时视图。
...
![[content/Data Architecture/images/lambda-twitter.png]]
