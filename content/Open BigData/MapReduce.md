...
>  [[Apache Hadoop Overview|Hadoop]] MR是Google [MapReduce](https://static.googleusercontent.com/media/research.google.com/en//archive/mapreduce-osdi04.pdf)的开源实现；同理Google的MR运行在GFS上，Hadoop MR运行在[[HDFS]] 上
