...
**DataWorks** 是阿里云推出的企业级大数据开发治理平台，基于[[What's MaxCompute?]]、[[Hologres]]、EMR、AnalyticDB、CDP等大数据引擎，为数据仓库、数据湖、湖仓一体等解决方案提供统一的全链路大数据开发治理平台。
...
![[content/index/Cloud/images/dw-离线与实时一体化的企业级智能云数仓.png]]
...
> [!info]详情参考：[支持的计算引擎与数据源](https://help.aliyun.com/zh/dataworks/user-guide/services-that-work-with-dataworks?spm=a2c4g.11186623.help-menu-72772.d_0_0_6.63ff7f3f0Lb0RD)
