---
title: Data Management Capability Maturity Assessment Model (DCMM)
aliases:
  - DCMM
...
## DCMM Capability Framework Merged Table

| 能力域 (Capability Domain)          | 能力项 (Capability Item)                                                                                                                           |
| -------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
...
| **数据标准** (Data Standard)         | - 业务术语 (Business Term)<br>- 参考数据和主数据 (Reference Data and Master Data)<br>- 数据元 (Data Element)<br>- 指标数据 (Indicator Data)                        |
| **数据生存周期** (Data Lifecycle)      | - 数据需求 (Data Requirement)<br>- 数据设计和开发 (Data Design and Development)<br>- 数据运维 (Data Operation and Maintenance)<br>- 数据退役 (Data Retirement)     |
...
- [eirc-icai.org/uploads/background\_materials/DCMM IMPLEMENTATION GUIDE\_1710484164.pdf](https://www.eirc-icai.org/uploads/background_materials/DCMM%20IMPLEMENTATION%20GUIDE_1710484164.pdf)
...
### DCMM 2.0 Update
- [国家标准 - 全国标准信息公共服务平台](https://std.samr.gov.cn/gb/search/gbDetailed?id=473EBB99D6AB455EE06397BE0A0ABB9A) [在线预览\|\|GB/T 36073-2025](http://c.gb688.cn/bzgk/gb/showGb?type=online&hcno=22559F9C7BF9EAC6A3927223FE33CE20&request_locale=zh)
