...
- **文件与湖仓**：FileSystem connector + Parquet/Avro/ORC；需要更新表与 changelog 时结合 [[ApachePaimon|Apache Paimon]] 等湖仓存储。
...
- [[ApachePaimon|Apache Paimon]]：实时湖仓存储与 changelog。
