...
export const BookmarkPage: QuartzEmitterPlugin<Options> = (userOpts) => {
  const opts: FullPageLayout = {
    ...sharedPageComponents,
    ...defaultListPageLayout,
    ...userOpts,
    pageBody: BookmarkContent(),
  }
  ...
  return {
    ...
    async *emit(ctx, content, resources) {
      ...
      const slug = "bookmarks/index" as FullSlug
      const [tree, vfile] = defaultProcessedContent({
        slug,
        text: "",
        frontmatter: { title: "Bookmarks", tags: [] },
      })
