...
/* In goods.md, add:                                                 */
/*   <link rel="stylesheet" href="/static/goods/goods-gallery.css"> */
/*   <div id="goods-gallery-root"></div>                             */
/*   <script src="/static/goods/goods-gallery.js"></script>          */
...
(function () {
  ...
  function openModal(item) {
    ...
    // double rAF ensures transition fires after display:flex
  ...
  // ── Load data and init ────────────────────────────────────────────
  fetch("/static/goods/goods-data.json")
    .then(r => {
